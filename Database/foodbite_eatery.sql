CREATE DATABASE  IF NOT EXISTS `foodbite_eatery` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `foodbite_eatery`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: foodbite_eatery
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'foodbite_eatery'
--
